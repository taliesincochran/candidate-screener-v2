...
var app = {
  ...
  blob: undefined,
  answer: "",
  answerArr: ["Thanks for all the birthday wishes!", "Has anyone in Nashville rented out their house on Airbnb? I'm looking for an example of the letter written to neighbors that the city requires.", "Yooooooo when are you coming down to Nashville?", "Hahaha I've never seen this picture! I look like an alien", "Miss you guys, too! We definitely need to catch up soon!", "Just got a new 615 phone number and finished assimilating into Nashville. PM me if you want it!", "Cool song, dudes.", "Ehh it's coming. Kind of focused on buying a house in Nash right now but we have some loose plans to do another record here ASAP", "Where are you going to be in England?? I want to come hang with you guys over there", "Has anyone bought a house in Nashville recently? Looking for real estate agent recommendations..", "Hey Caadi! Sorry I missed your post, I deleted Facebook from my phone so I'm not on it quite as much. Not aware of anything off the top of my head, but I'm planning on buying a house with rooms to rent out later this year if that's helpful in any way haha", "So sad to hear about David Bowie. Such a great artist", "It's scary that people in America think Donald Trump is a good decision", "Drove into DC behind this guy tonight.. Time to get a posse together", "If anyone in Nashville is interested in a 2000 Jeep Grand Cherokee 4WD with 115,000 miles!", "Anyone have good recommendations for a car mechanic in Nashville?", "Looking for a band to share our rehearsal space in Nashville at Diamond Sound Studios. $250 a month! DM me", "Thanks so much for all the birthday wishes! 27 is going to be a good one", "Tonights the night! Come check us out at The High Watt w/ Lovedrug, Chapels, and Brave Town. Doors at 8PM", "Playing with Lovedrug, Chapels, and Brave Town at the The High Watt on Saturday at 8. Come check it out!", "Ready for practice @matthewjaykennedy @schaffingtonstin @andywildrk @youngpearlman #music #rock #instagood #instadaily #happy #bands #band #mapex #vox #fender #perfect #rocknroll #livemusic #fastastronaut #nashville #nashvilletn", "Cool video about a cool venue", "Have a few awesome shows with Fast Astronaut coming up! Three in Illinois this week and then opening for Lovedrug's album release show w/ Chapels and Brave Town on 9/5", "Nashville friends, come see Fast Astronaut open up for Lovedrug! The show will most likely sell out, so get tickets ahead of time", "It gets harder to leave New York every time I come out here. Maybe I should just stay", "Does anyone in Nashville know of any practice space lockouts for bands that are available? Struggling to find a good spot!", "Playing our last show in Nashville for awhile at Mercy Lounge tonight. Come check us out! Show's at 8 and we're on around 11", "Playing a FREE show at The Basement East @ 9 tonight. Come on out for some cool bands!", "This is important and seems to be slipping under the radar:", "Going to be an awesome show tonight at The End", "THAT looks like a good time! Thanks for the shout out!", "The man. The myth. The legend.", "Anyone in NYC? Staying with Haley in East Village tonight", "Ahh man I'm heading out today! Was just in for the night", "Fast Astronaut goes international", "Loosening up for our Viper Room show tonight in the massage chair at the airport. LA friends come see Fast Astronaut's first show in town!"],
  personalityProfile: {},
  record: () => {
...
$(document).ready(function(){   
  ...
  app.answerArr.forEach((val) => {app.wordCount += val.split(" ").length});
  app.progressUpdate();
  console.log("Word Count: ", app.wordCount);
  // $("#sunburstArea").hide();
  console.log("fired");   
  ...
  // });
  // end temp code
  // $("#getPersonalityBtn").on("click", function() {
  //   $("td.column" + 0).each(function(i,cell){
  //       $(cell).text(Math.round(returnedData.percentileArray[i] * 100) + " %"); 
  //   })
  // })
